...
!function (t, e) {
  ...
  define.amd ? define([], e) : 'object' == typeof exports ? exports.baffle = e() : t.baffle = e()
}(
  this,
  function () {
    return function (t) {
      ...
      function (t, e) {
        ...
        function s(t) {
          return 'string' == typeof t ? [].slice.call(document.querySelectorAll(t)) : [
            NodeList,
            HTMLCollection
          ].some(function (e) {
            return t instanceof e
          }) ? [].slice.call(t) : t.nodeType ? [
            t
          ] : t
        }
      ...
      function (t, e, n) {
        ...
        a = function () {
          ...
          t.prototype.set = function (t) {
            return (0, o.extend) (this.options, t),
            this.running &&
            this.start(),
            this
          },
          ...
          t.prototype.reveal = function () {
            ...
            void 0 === arguments[1] ? 0 : arguments[1],
            r = e / this.options.speed ||
            1,
            i = function () {
              ...
              t.interval = setInterval(
                function () {
                  ...
                  e.length ||
                  (t.stop(), (0, o.each) (t.elements, function (t) {
                    return t.init()
                  }))
                },
                t.options.speed
        ...
        s = function () {
          ...
          t.prototype.decay = function () {
            for (
              ...
              void 0 === arguments[0] ? 1 : arguments[0];
              t--;
            ) {
          ...
          t.prototype.text = function () {
            var t = arguments.length <= 0 ||
            void 0 === arguments[0] ? this.value : arguments[0];
            return this.value = t,
            this.init(),
            this
          },
